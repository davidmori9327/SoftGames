const magicWordsData = {
    dialogue: [
        ...
        {
            name: "Penny",
            text: "See? Casual gaming brings people together!",
        },
        {
            name: "Leonard",
...
export type MagicWordsFallback = typeof magicWordsData;

export default magicWordsData;
